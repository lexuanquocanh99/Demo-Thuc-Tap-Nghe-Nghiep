...
class PostCommentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.post_comment.index')->with('comments',$comments);
    }
    ...
    public function edit($id)
    {
        ...
        if($comments){
            return view('admin.post_comment.edit')->with('comment',$comments);
        }
        else{
    ...
    public function destroy($id)
    {
        ...
        if($comment){
            ...
            if($status){
                request()->session()->flash('success','Bình luận đã được xóa');
            }
            else{
                request()->session()->flash('error','Vui lòng thử lại');
            }
