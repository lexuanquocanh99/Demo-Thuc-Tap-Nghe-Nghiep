                    ...
                    <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($reviews as $review)
                            ...
                            <tr>
                                ...
                                <td>{{$review->created_at->format('d/m/Y H:m:i')}}</td>
                                <td>
                                ...
                                <td>
                                    <a href="{{route('product-review.edit',$review->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                                    <form method="POST" action="{{route('product-review.delete',[$review->id])}}">
                                        @csrf
                                        @method('delete')
