...
@section('title','HOA HONG MOBILE || THẺ')
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('post-tag.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Tạo Thẻ"><i class="fas fa-plus"></i> Tạo Thẻ</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                @else
                    <h6 class="text-center">Không tìm thấy bất kì thẻ nào! Hãy tạo một thẻ</h6>
                @endif
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.dltBtn').click(function(e){
                ...
                swal({
                    title: "Bạn chắc chứ?",
                    text: "Nếu bạn xoá thẻ này, bạn không thể khôi phục lại giá trị đã mất!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
