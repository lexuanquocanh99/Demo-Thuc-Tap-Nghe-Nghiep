...
@section('title','HOA HONG MOBILE || VẬN CHUYỂN')
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{route('shipping.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Tạo Vận Chuyển"><i class="fas fa-plus"></i> Tạo Vận Chuyển</a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                ...
                @else
                    <h6 class="text-center">Không tìm thấy bất kì vận chuyển nào! Hãy tạo một vận chuyển</h6>
                @endif
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.dltBtn').click(function(e){
                ...
                swal({
                    title: "Bạn chắc chứ?",
                    text: "Nếu bạn xoá vận chuyển này, bạn không thể khôi phục lại giá trị đã mất!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
