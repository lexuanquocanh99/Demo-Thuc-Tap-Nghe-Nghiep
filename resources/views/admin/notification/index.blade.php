...
@section('title','HOA HONG MOBILE || THÔNG BÁO')
                ...
                <table class="table  table-hover admin-table" id="notification-dataTable">
                    ...
                    @foreach (Auth::user()->Notifications as $notification)
                        ...
                        <tr class="@if($notification->unread()) bg-light border-left-light @else border-left-success @endif">
                            ...
                            <td>{{$notification->created_at->format('d/m/Y H:m:i')}}</td>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.dltBtn').click(function(e){
                ...
                swal({
                    title: "Bạn chắc chứ?",
                    text: "Nếu bạn xoá thông báo này, bạn không thể khôi phục lại giá trị đã mất!",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
