...
@section('title','HOA HONG MOBILE || HỒ SƠ')
...
<div class="card shadow mb-4">
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('user')}}" style="color:#999">Bảng Quản Trị</a></li>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-thumbnail roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;background:#ffffff" src="{{asset('storage/'.$profile->photo)}}" alt="profile picture">
                        @else
                        <img class="card-img-top img-thumbnail roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('backend/img/avatar.png')}}" alt="profile picture">
                        @endif
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @if(isset($profile->photo))
                                <img class="img-thumbnail mt-2" id="img-preview" width="300px" src="{{asset('storage/'.$profile->photo)}}"/>
                            @endif
                        </div>
