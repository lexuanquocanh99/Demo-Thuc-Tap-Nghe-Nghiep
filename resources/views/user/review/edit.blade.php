...
@section('title','HOA HONG MOBILE || CHỈNH SỬA ĐÁNH GIÁ')
  ...
  <div class="card-body">
    <form action="{{route('user.product-review.update',$review->id)}}" method="POST">
      ...
      <div class="form-group">
        ...
        <input readonly type="text" disabled class="form-control" value="{{$review->user_info->name}}">
      </div>
      <div class="form-group">
        <label for="review">Đánh giá :</label>
      <textarea readonly name="review" id="" cols="20" rows="10" class="form-control">{{$review->review}}</textarea>
      </div>
      <div class="form-group">
