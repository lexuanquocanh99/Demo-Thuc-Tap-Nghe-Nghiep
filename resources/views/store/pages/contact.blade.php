...
@section('title','HOA HONG MOBILE || LIÊN HỆ')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group message">
                                            <label>Thông điệp của bạn<span>*</span></label>
                                            <textarea name="message" id="message" cols="30" rows="9" placeholder="Nhập thông điệp"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-12">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="text-success">Cảm Ơn Bạn Đã Đóng Góp Ý Kiến!</h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p class="text-success">Thông điệp của bạn đã được gửi đi...</p>
                </div>
            </div>
        </div>
    </div>
