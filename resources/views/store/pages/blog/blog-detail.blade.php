                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="{{route('blog')}}">Bài Viết<i class="ti-arrow-right"></i></a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    ...
                                    <!-- Single Comment -->
                                @include('store.pages.comment', ['comments' => $post->comments, 'post_id' => $post->id, 'depth' => 3])
                                <!-- End Single Comment -->
                                </div>
                            </div>
                        </div>
                        ...
                        @foreach($recent_posts as $post)
                            <!-- Single Post -->
                                <div class="single-post">
                                    <div class="image">
                                        <img class="img-thumbnail" src="{{asset('storage/'.$post->photo)}}" alt="{{$post->photo}}">
                                    </div>
                                    <div class="content">
